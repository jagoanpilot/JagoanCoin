...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("explorer.jagoancoin.org");
        vSeeds.emplace_back("api.jagoancoin.org");
        vSeeds.emplace_back("bot.jagoancoin.org");
        vSeeds.emplace_back("wallet.jagoancoin.org");


        // Jagoancoin addresses start with 'J'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,43);
        // Jagoancoin script addresses start with '7'
...
//        }
        ...
        vSporkAddresses = {"JU2oYAHjFCSM3cpoiYxWspCKfws8yiNUf9"};
        nMinSporkKeys = 1;
